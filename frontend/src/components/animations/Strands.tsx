...
export function Strands({
  ...
  const propsRef = useRef<Partial<StrandsProps>>({});
  ...
  }, [speed, amplitude, waviness, thickness, glow, taper, spread, hueShift, intensity, opacity, scale, saturation, glassSize, refraction, dispersion]);
